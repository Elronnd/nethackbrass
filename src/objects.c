...
WEAPON("broadsword", (char *)0,
	1, 0, 0, 15, 70, 10, DAM(2,6), DAM(2,6), 0, DBON(1,0), S, P_LONG_BLADE_GROUP, 0, IRON, 0, HI_METAL),
						/* (2d4/1d6+1) --> (2d6+1/2d6) */
WEAPON("elven broadsword", "runed broadsword",
	0, 0, 0,  4, 70, 10, DAM(2,6), DAM(2,6), 0, DBON(2,1), S, P_LONG_BLADE_GROUP, 0, IRON, 0, HI_METAL),
						/* (1d6+d4/1d6+1) --> (2d6+2/2d6+1) */
...
ARMOR("studded leather armor", (char *)0,
	1, 0, 0, 0,	70, 3, 200,  15,  6/*7*/, 1, ARM_SUIT, LEATHER, 0, HI_LEATHER),
...
TOOL("magic candle", "candle",  0, 1, 1, 0,   2,  2, 500, WAX, CLR_WHITE),
...
TOOL("towel", (char *)0,        1, 0, 0, 0,  60,  2,  50, CLOTH, CLR_MAGENTA),
#ifdef STEED
...
POTION("restore ability", "pink",       1, 0,          42, 100, CLR_BRIGHT_MAGENTA),
POTION("confusion", "orange",           1, CONFUSION,  52, 100, CLR_ORANGE),
...
POTION("healing", "purple-red",         1, 0,          67, 100, CLR_MAGENTA),
...
#define SCROLL(name,text,mgc,prob,cost) OBJECT( \
	...
	SCROLL("remove curse",          "PRATYAVAYAH",          1,  65, 100),
...
WAND("wishing",        "pine",      5,1500, 1, NODIR,     WOOD,     HI_WOOD),
...
OBJECT(OBJ("statue", (char *)0), BITS(1,0,0,1,0,0,0,0,0,1,0,P_NONE,MINERAL), 0,
		ROCK_CLASS,   900, 0, 2500,  0, DAM(1,20), DAM(1,20), 0, 0, 2500, CLR_WHITE),
