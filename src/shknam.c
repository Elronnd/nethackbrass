...
static const char *shktailor[] = {
    /* Hello project */
    "Natchi", "Kaorin", "Yosswee", "Ricacci", "Gotzcin", "Kemeco",
    "Marippe", "Aybon", "Nono", "Gakisan", "Takahashi", "Konno",
    "Makopee", "Ayaya", "Mikity", "Shigesan", "Tanaka", "Kamei",
    0
};
...
const struct shassortment candleshop_assortment[] = {
	...
	{5, -BRASS_LANTERN}, {10, -OIL_LAMP},
	{3, -MAGIC_LAMP}, {2, -MAGIC_CANDLE},
	{0, 0}
};
...
/*  shop name				shop type    prob         assortment		   shk name */
  {"general store",			RANDOM_CLASS, 42, D_SHOP, generalstore_assortment, shkgeneral},
  {"used armor dealership",		ARMOR_CLASS,  14, D_SHOP, armorshop_assortment,    shkarmors},
  {"second-hand bookstore",		SCROLL_CLASS, 10, D_SHOP, scrollshop_assortment,   shkbooks},
  {"liquor emporium",			POTION_CLASS, 10, D_SHOP, liquorshop_assortment,   shkliquors},
  {"antique weapons outlet",		WEAPON_CLASS,  5, D_SHOP, weaponshop_assortment,   shkweapons},
  {"delicatessen",			FOOD_CLASS,    5, D_SHOP, foodshop_assortment,     shkfoods},
  {"jewelers",				RING_CLASS,    3, D_SHOP, jewelers_assortment,     shkrings},
  {"quality apparel and accessories",	WAND_CLASS,    3, D_SHOP, wandshop_assortment,     shkwands},
  {"hardware store",			TOOL_CLASS,    3, D_SHOP, toolshop_assortment,     shktools},
	/* Actually shktools is ignored; the code specifically chooses a
	 * random implementor name (along with candle shops having
	 * random shopkeepers)
	 */
  {"rare books",			SPBOOK_CLASS,  3, D_SHOP, bookshop_assortment,     shkbooks},
  {"stylish clothing store",		ARMOR_CLASS,   2, D_SHOP, tailorshop_assortment,   shktailor},
	/* Shops below this point are "unique".  That is they must all have a
	 * probability of zero.  They are only created via the special level
	 * loader.
	 */
  {"lighting store",			TOOL_CLASS,    0, D_SHOP, candleshop_assortment,   shklight},
  {(char *)0,				0,	       0, 0,	  0,			   0}
};
