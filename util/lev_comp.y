...
object_infos	: /* nothing */
	 ...
	 */
		...
		| ',' curse_state ',' monster_id ',' enchantment material_id optional_name
		  {
		  }
		| ',' curse_state ',' enchantment material_id optional_name
		  {
		  }
		| ',' monster_id ',' enchantment material_id optional_name
		  {
		  }
		;
